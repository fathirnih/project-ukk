        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('koleksi') ? 'active' : '' }}" href="{{ route('koleksi') }}">Koleksi Buku</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('anggota') ? 'active' : '' }}" href="{{ route('anggota') }}">Anggota</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    @if(session('anggota_id'))
                        <li class="nav-item">
                            <span class="nav-link">Halo, {{ session('anggota_nama') }}</span>
                        </li>
                        <li class="nav-item">
